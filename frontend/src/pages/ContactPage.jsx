        ...
        <ContentWrapper>
            <main className="contact-main-content">
                ...
                <section className="contact-hero">
                    <img src={heroImage} alt="Contato Bohemian Home" className="contact-hero-image" />
                    <div className="contact-hero-overlay">
                        <div className="contact-breadcrumbs">
                            <Link to="/">Home</Link> &gt; <span>Contato</span>
                        </div>
                        <h1 className="contact-page-title-hero">Entre em Contato</h1>
                        <p className="contact-hero-subtitle">
                            Estamos aqui para transformar suas ideias em arranjos inesquecíveis.
                        </p>
                    </div>
                </section>
